...
const BottomButtonContainer = (props) => {
  ...
  return (
    <div className={classes.btn_container}>
     ...
     {!props.noCancel&& <button type='button' disabled={props.disabled} className={classes.cancel} onClick={props.func === true ? () => props.cancelRequests() : backHandler}>{props.cancel}</button>}
