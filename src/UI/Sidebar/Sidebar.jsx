  ...
  return (
    <div className={classes.sidebar}>
      ...
      <NavLink onClick={() => { props.onSideberBtn() }} to={'/all_attendence'} className={`${classes.sidebar_a} ${location.pathname.includes('attendence_history') ? 'active' : ''}`} ><img src={Attendence} alt="" /> All Attendance </NavLink>
        ...
        {permissions.includes('Attendance') && <li>
          <NavLink onClick={() => { props.onSideberBtn() }} to={'/'} className={`${classes.sidebar_a} ${location.pathname.includes('attendence_approval') ? 'active' : ''}`} ><img src={Attendence} alt="" /> Attendance <PendingIcon table_name={'attendance_approval'}></PendingIcon></NavLink>
        </li>}
        <li>
        ...
        {permissions.includes('Employee Detail') && <li>
          <NavLink onClick={() => { props.onSideberBtn() }} to={'/employee_details'} className={`${classes.sidebar_a} ${location.pathname.includes('employee_details')||location.pathname.includes('add_employee')||location.pathname.includes('edit_employee')  ? 'active' : ''}`}><img src={Wallet} alt="" />Employee Details</NavLink>
        </li>}
        <li>
        ...
        {permissions.includes('Salary') && <li>
          <NavLink onClick={() => { props.onSideberBtn() }} to={'/salary_summary'} className={`${classes.sidebar_a} ${location.pathname.includes('salary_summary') ? 'active' : ''}`}><img src={Wallet} alt="" />Salary Summary</NavLink>
        </li>}
        <li>
          <NavLink onClick={() => { props.onSideberBtn() }} to={'/employee_transfer'} className={`${classes.sidebar_a} ${location.pathname.includes('transfer') ? 'active' : ''}`}><img src={Arrows} alt="" />Employee Transfer<PendingIcon table_name={'transfer_details'}></PendingIcon></NavLink>
        </li>
        <li>
        ...
        <li>
          <NavLink onClick={() => { props.onSideberBtn() }} to={'/grade'} className={`${classes.sidebar_a} ${location.pathname.includes('grade') ? 'active' : ''}`}><img src={Tie} alt="" />Grade<PendingIcon table_name={'grades'}></PendingIcon></NavLink>
        </li>
        ...
        {/* <li>
          <NavLink onClick={() => { props.onSideberBtn() }} to={'/roles'} className={`${classes.sidebar_a} ${location.pathname.includes('role') ? 'active' : ''}`}><img src={User} alt="" />Roles</NavLink>
        </li> */}
        <li>
          <NavLink onClick={() => { props.onSideberBtn() }} to={'/bonus'} className={`${classes.sidebar_a} ${location.pathname.includes('bonus') ? 'active' : ''}`}><img src={Report} alt="" />Bonus</NavLink>
        </li>
        {/* <li>
        ...
        <li>
          <NavLink onClick={() => { props.onSideberBtn() }} to={'/notification'} className={`${classes.sidebar_a} ${location.pathname.includes('notification') ? 'active' : ''}`}><img src={Report} alt="" />Notification</NavLink>
        </li>
