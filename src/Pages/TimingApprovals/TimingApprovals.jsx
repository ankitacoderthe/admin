...
let    from_date = moment()
  ...
  useEffect(() => {
    ...
    let getString = url + "api/getAttendanceCorrectionRequests?" + "&limit=" + limit + "&offset=" + offset + "&type='Out For Some Work'"
    if (date?.length>1){
    ...
    getString = url + "api/getAttendanceCorrectionRequests?"   + "&type='Out For Some Work'"
    if (date?.length>1){
      let from_date=moment(date[0].toDate())
