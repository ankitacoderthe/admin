...
const AddInterview = () => {
    ...
    useEffect(() => {
        const headers = { "Authorization": "Bearer " + token }
            ...
            axios.get(url + "api/getEmployeesBasedOnRole?role_name=HR Head" , { headers }).then((response) => {
    ...
    useEffect(() => {
        ...
        axios.get(url + "api/getAllEmployees", { headers }).then((response) => {
            ...
            <form className={classes.container} onSubmit={add}>
             ...
             <button type='button' className={classes.add_inp} onClick={increaseFile}>Add File</button>
                ...
                <div className={classes.btn_container}>
                    ...
                    <button disabled={isLoading} type={'submit'} className={classes.accept} >Add Interview</button>
                </div>
            </form>
